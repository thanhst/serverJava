            ...
            if (rs.first()) {
                ...
                if (rs.getBoolean("ban")) {
                    Service.getInstance().sendThongBaoOK(session,
                            "Tài khoản đã bị khóa vì dựa vào lỗi admin chuộc lợi!");
                    ...
                    if (plInGame != null) {
                        ...
                        Service.getInstance().sendThongBaoOK(session,
                                "Tài khoản của bạn hiện đang online trong server!!!");
                    } else {
                    }
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            try {
                                ...
                                if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapGiaiCuuMiNuong(mapId)
                                        || MapService.gI().isNguHanhSon(mapId)
        ...
        try {
            ...
            if (rs.first()) {
                ...
                try {
                    ...
                    player.location.y = Integer.parseInt(String.valueOf(dataArray.get(2)));
                    if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapGiaiCuuMiNuong(mapId)
                            || MapService.gI().isNguHanhSon(mapId) || MapService.gI().isMapBlackBallWar(mapId)
                            || MapService.gI().isMapKhiGaHuyDiet(mapId) || MapService.gI().isMapConDuongRanDoc(mapId)
                            || MapService.gI().isMapBanDoKhoBau(mapId)) {
                        mapId = player.gender + 21;
                        player.location.x = 300;
                        player.location.y = 336;
