...
public class BossData2 {
    ...
    private BossData2(String name, byte gender, short[] outfit, int dame, float[] hp,
    ...
    @Builder
    public BossData2(String name, byte gender, int dame, float[] hp,
    ...
    public BossData2(String name, byte gender, short[] outfit, int dame, float[] hp,
            int[] mapJoin, int[][] skillTemp, String[] textS, String[] textM,
