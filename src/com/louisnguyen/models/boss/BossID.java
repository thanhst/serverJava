...
public class BossID {
    ...
    public static int TRUNG_UY_XANH_LO_BDKB;
    ...
    public static final int MAI = -245;
    public static final int SU = -246;
    public static final int PI_LAP = -247;
    
    public static final int THAN_HUY_DIET = -249;
    public static final int THAN_THIEN_SU = -250;
    
    public static final int JACKY_CHUN2 = -251;
    public static final int QUY_LAO = -252;
    ...
    //BA CON SÓI
    public static final int BACONSOI = -253;
