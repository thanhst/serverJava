...
public class SuperNamecNail extends Boss {

    public SuperNamecNail() throws Exception {
        super(2049, BossesData.Nail, BossesData.SuperNail);
    }

    @Override
    public void reward(Player plKill) {
        if (this.name.equals("Nail")) {
            if (Util.isTrue(100, 100)) {
                ItemMap caitrangBrolyNamec= new ItemMap(this.zone, 2049, 1, this.location.x,
                ...
                caitrangBrolyNamec.options.add(new Item.ItemOption(227, 5));
            ...
            if (Util.isTrue(5, 100)) {
                ItemMap caitrangBrolyNamec2 = new ItemMap(this.zone, 2049, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        plKill.id);
                ...
                caitrangBrolyNamec2.options.add(new Item.ItemOption(227, 5));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(160, 50));
                Service.getInstance().dropItemMap(this.zone, caitrangBrolyNamec2);
            }
        } else {
            if (Util.isTrue(100, 100)) {
                ItemMap caitrangBrolyNamec = new ItemMap(this.zone, 2048, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        plKill.id);
                ...
                caitrangBrolyNamec.options.add(new Item.ItemOption(228, 4));
                caitrangBrolyNamec.options.add(new Item.ItemOption(229, 4));
                caitrangBrolyNamec.options.add(new Item.ItemOption(106));
                caitrangBrolyNamec.options.add(new Item.ItemOption(116));
                caitrangBrolyNamec.options.add(new Item.ItemOption(99,100));
                // caitrangBrolyNamec.options.add(new Item.ItemOption(93, new Random().nextInt(3) + 4));
                Service.getInstance().dropItemMap(this.zone, caitrangBrolyNamec);
            }
            // if (Util.isTrue(5, 100)) {
