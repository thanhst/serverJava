package com.louisnguyen.models.boss.list_boss.BrolyXayda;
...
public class SieuXaydaHuyenThoai extends Boss {

    public SieuXaydaHuyenThoai() throws Exception {
        super(2052, BossesData.Xayda_origin_king, BossesData.SieuXaydaHuyenThoai);
    }

    @Override
    public void reward(Player plKill) {
        if (this.name.equals("Xayda nguyên thủy")) {
            if (Util.isTrue(100, 100)) {
                ItemMap caitrangBrolyNamec = new ItemMap(this.zone, 2053, 1, this.location.x,
                ...
                caitrangBrolyNamec.options.add(new Item.ItemOption(232, 5));
            ...
            if (Util.isTrue(5, 100)) {
                ItemMap caitrangBrolyNamec2 = new ItemMap(this.zone, 2053, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        plKill.id);
                caitrangBrolyNamec2.options.add(new Item.ItemOption(50, Util.nextInt(10, 30)));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(77, Util.nextInt(10, 30)));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(103, Util.nextInt(10, 30)));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(232, 5));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(160, 50));
                Service.getInstance().dropItemMap(this.zone, caitrangBrolyNamec2);
            }
        } else {
            if (Util.isTrue(100, 100)) {
                ItemMap caitrangBrolyNamec = new ItemMap(this.zone, 2052, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        plKill.id);
                ...
                caitrangBrolyNamec.options.add(new Item.ItemOption(232, 4));
                caitrangBrolyNamec.options.add(new Item.ItemOption(233, 2));
                caitrangBrolyNamec.options.add(new Item.ItemOption(234, 4));
                caitrangBrolyNamec.options.add(new Item.ItemOption(106));
                caitrangBrolyNamec.options.add(new Item.ItemOption(116));
                caitrangBrolyNamec.options.add(new Item.ItemOption(153, 100));
                Service.getInstance().dropItemMap(this.zone, caitrangBrolyNamec);
            }
            // if (Util.isTrue(5, 100)) {
            //     ItemMap caitrangBrolyNamec2 = new ItemMap(this.zone, 2052, 1, this.location.x,
            //             this.zone.map.yPhysicInTop(this.location.x,
            //                     this.location.y - 24),
            //             plKill.id);
            ...
            //     caitrangBrolyNamec2.options.add(new Item.ItemOption(232, 4));
