...
public class BrolyTraidat extends Boss {
    public BrolyTraidat() throws Exception {
        super(2055, BossesData.BrolyTD, BossesData.SuperBrolyTD);
    }

    @Override
    public void reward(Player plKill) {
        if (this.name.equals("Broly Trái Đất")) {
            if (Util.isTrue(100, 100)) {
                ItemMap caitrangBrolyNamec = new ItemMap(this.zone, 2054, 1, this.location.x,
                ...
                caitrangBrolyNamec.options.add(new Item.ItemOption(159, 2));
            ...
            if (Util.isTrue(5, 100)) {
                ItemMap caitrangBrolyNamec2 = new ItemMap(this.zone, 2054, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        plKill.id);
                ...
                caitrangBrolyNamec2.options.add(new Item.ItemOption(159, 2));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(160, 50));
                Service.getInstance().dropItemMap(this.zone, caitrangBrolyNamec2);
            }
        } else {
            if (Util.isTrue(100, 100)) {
                ItemMap caitrangBrolyNamec = new ItemMap(this.zone, 2055, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        plKill.id);
                caitrangBrolyNamec.options.add(new Item.ItemOption(50, 23));
            ...
            if (Util.isTrue(5, 100)) {
                ItemMap caitrangBrolyNamec2 = new ItemMap(this.zone, 2055, 1, this.location.x,
                        this.zone.map.yPhysicInTop(this.location.x,
                                this.location.y - 24),
                        plKill.id);
                caitrangBrolyNamec2.options.add(new Item.ItemOption(50, 23));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(77, 21));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(103, 21));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(159, 4));
                caitrangBrolyNamec2.options.add(new Item.ItemOption(160, 50));
                Service.getInstance().dropItemMap(this.zone, caitrangBrolyNamec2);
            }
        }
