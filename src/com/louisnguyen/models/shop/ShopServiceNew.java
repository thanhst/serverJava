...
private boolean CaiTrangShop(ItemShop itemShop, int idcaitrang) { // hàm để lấy vật phẩm muốn mua trong shop //   By Louis Nguyễn
    
    int itemId = itemShop.temp.id;
    return itemId == idcaitrang;
}

private boolean CanPhaiCoVatPham(Player player, int idvatpham, int soluong) {  // hàm để check số lượng vật phầm cần để mới có thể mua // By Louis Nguyễn
