...
public class Zone {
    ...
    public void setIsTrungUyTrangAlive(boolean isTrungUyTrangAlive) {
        this.isTrungUyTrangAlive = isTrungUyTrangAlive;
    }

    public void setIsbulon13Alive(boolean isbulon13Alive) {
        this.isbulon13Alive = isbulon13Alive;
    }

    public void setIsbulon14Alive(boolean isbulon14Alive) {
        this.isbulon14Alive = isbulon14Alive;
    }
    ...
    public void setYajiro(Player Yajiro) {
        this.Yajiro = Yajiro;
    }

    public static byte getPLAYERS_TIEU_CHUAN_TRONG_MAP() {
        return PLAYERS_TIEU_CHUAN_TRONG_MAP;
    }
    ...
    public boolean isIsTrungUyTrangAlive() {
        return isTrungUyTrangAlive;
    }

    public boolean isIsbulon13Alive() {
        return isbulon13Alive;
    }

    public boolean isIsbulon14Alive() {
        return isbulon14Alive;
    }
    ...
    public Zone(Map map, int zoneId, int maxPlayer) {
        ...
        // yajiro.initYajiro();
        // } else if (map.mapId == 52 || map.mapId==129) {
        // Referee refereeDHVT = new Referee();
        // refereeDHVT.initReferee();
        // }
    }
    ...
    public void addPlayer(Player player) {
        ...
        // System.out.println(this.humanoids);
    }
    ...
    private void infoPlayer(Player plReceive, Player plInfo) {
        ...
        if (!plInfo.isBoss && !plInfo.isPet && !plInfo.isNewPet
                && !(plInfo instanceof Referee) & !(plInfo instanceof Yajiro)) {
