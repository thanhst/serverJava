...
import com.louisnguyen.consts.ConstRatio;
...
public class NPoint {
    ...
    private void setHpMax() {
        ...
        // set Vegeta
        if (this.player.setClothes.Vegeta == 5) {
    ...
    private void setCrit() {
        ...
        for (Integer tl : this.tlCrit) {
            this.crit += (this.crit * tl / 100);
        }
        // if (this.player.setClothes.Angry_goku == 5) {
        // this.crit += 79;
        // return;
    ...
    public long calSucManhTiemNang(long tiemNang) {
        if (power < getPowerLimit()) {
            ...
            // if (this.player.isPet) {
            // if (((Pet) this.player).master.charms.tdMaBu1 > System.currentTimeMillis() &&
    ...
    public long calSubTNSM(long tiemNang) {
        ...
        if (power >= 100_000_000_000L && power < 200_000_000_000L) {
    ...
    public void powerUp(long power) {
        if (player.nPoint.power >= 210999999999L) {
            this.power += 0;
        } else {
            this.power += power;
        }
