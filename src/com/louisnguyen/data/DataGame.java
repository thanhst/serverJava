...
public class DataGame {
    ...
    public static String LINK_IP_PORT = "ngocrong:3.25.116.231:14445";
    ...
    public static void sendVersionGame(MySession session) {
        Message msg;
        try {
            msg = com.louisnguyen.services.Service.gI().messageNotMap((byte) 4);
    ...
    public static void updateMap(MySession session) {
        ...
        Message msg;
        try {
            msg = com.louisnguyen.services.Service.gI().messageNotMap((byte) 6);
            msg.writer().writeByte(vsMap);
