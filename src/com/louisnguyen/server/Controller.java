...
public class Controller implements IMessageHandler {
    ...
    public void onMessage(ISession s, Message _msg) {
        ...
        try {
            ...
            switch (cmd) {
                ...
                // Trang chủ HuyenThoaiBlue.Com .Vui lòng không sử dụng phầm mềm thứ 3 hoặc
                ...
                case 34:
                    if (player != null) {
                        ...
                        // System.out.println("Chonj skill");
                    }
                    break;
                case 54:
                    if (player != null) {
    ...
    public void login2(MySession session, Message msg) {
        Service.gI().sendThongBaoOK(session, "Bảo anh Thanh đăng ký cho nhá ,cái này anh chưa có code lại ...");
    }
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            ...
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với sever Thanhxk2003\n"
        ...
        //                     (short) (player.inventory.itemsBody.get(9).template.iconID-1), (byte) 1, (short) 35,
        //                     (short) 30, player.session, new byte[] { 0,1,2,3,4,5,6,7 });
        //         } catch (Exception e) {
        //         }
        //     }).start();
        // }
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player,
                "Máy chủ sẽ bảo trì định kì lúc 00h sáng để chạy ổn định mà không gặp\bcác lỗi Boss, Kẹt nick...\bAnh Thanh chào tất cả các anh em!!!");
    }
